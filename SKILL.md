...
```bash
# 只监控，不自动回复
python {baseDir}/agent.py start_monitor --interval 10 --max_loops 100

# 监控并自动回复固定内容
python {baseDir}/agent.py start_monitor --interval 10 --max_loops 100 --auto_reply "好的，稍后回复你"
```
